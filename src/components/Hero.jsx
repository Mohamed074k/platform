    ...
    >
      <div className="hero-content">
        ...
        <p className="description">
          <TypingAnimation 
            text="لكل ما يتعلق بمنهج الاحياء بالثانويه العامه" 
            speed={80}
            className="typing-description"
          />
        </p>
        <div className="hero-years-buttons">
          <button className="year-btn year-btn-one">
            <span className="arrow-container">
              <AnimatedArrow />
            </span>
            <span>الصف الاول الثانوي</span>
          </button>
          <button className="year-btn year-btn-two">
            <span className="arrow-container">
              <AnimatedArrow />
            </span>
            <span>الصف الثاني الثانوي</span>
          </button>
          <button className="year-btn year-btn-three">
            <span className="arrow-container">
              <AnimatedArrow />
            </span>
